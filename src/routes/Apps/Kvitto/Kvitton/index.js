...
import { getUsersKvitto,downloadFile } from 'redux/actions';
...
function Kvitton(props) {
  //userKvitto
   ...
   React.useEffect(()=>{
      ...
      dispatch(getUsersKvitto(authUser.id,searchTerm,isEmpty(filterOptions)?[{date:moment(new Date()).format("YYYY-MM-DD")}]:filterOptions),
      () => {
        ...
        <div className={classes.root}>
            ...
            <TableContainer className={classes.container}>
                ...
                {!!userKvitto.length ? (
                  ...
                  <TableCell colSpan={props.isMobile?3:5} rowSpan={10}>
                    {isFilterApplied ? (
