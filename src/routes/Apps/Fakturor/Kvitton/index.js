...
import { getUsersFaktura,downloadFile } from 'redux/actions';
...
function Kvitton(props) {
  //userFakturor
   ...
   React.useEffect(()=>{
      ...
      dispatch(getUsersFaktura(authUser.id,searchTerm,isEmpty(filterOptions)?[{date:moment(new Date()).format("YYYY-MM-DD")}]:filterOptions),
      () => {
