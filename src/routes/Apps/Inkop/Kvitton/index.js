   ...
   const handlePageChange = (event, newPage) => {
    ...
    const handleRequestSort = (event, property) => {
     ...
     React.useEffect(()=>{
        ...
        dispatch(getUsersInkop(authUser.id,searchTerm,isEmpty(filterOptions)?[{date:moment(new Date()).format("YYYY-MM-DD")}]:filterOptions),
        () => {
      ...
      const handlefileDelete=(fileId,Url)=>{      
          dispatch(deleteInkop(authUser.id,fileId,Url,searchTerm,isEmpty(filterOptions)?[{date:moment(new Date()).format("YYYY-MM-DD")}]:filterOptions))
      }
        ...
        <div className={classes.root}>
            ...
            <TableContainer className={classes.container}>
                ...
                {!!userInkop.length ? (
                  ...
                  <TableCell colSpan={props.isMobile?4:8} rowSpan={10}>
                    {isFilterApplied ? (
