...
//
export const SET_USER_LOGG = 'SET_USER_LOGG';
//
...
export const SET_START_USER_DETAILS = 'SET_START_USER_DETAILS';
export const SET_USER_DETAILS = 'SET_USER_DETAILS';
export const EDIT_USER = 'EDIT_USER';
export const DELETE_USER = 'DELETE_USER';
export const DELETE_BULK_USERS = 'DELETE_BULK_USERS';
//
export const GET_UPDATE_USER_DETAIL_IMAGE = 'GET_UPDATE_USER_DETAIL_IMAGE';
export const GET_UPDATE_USER_DETAIL = 'GET_UPDATE_USER_DETAIL';
export const GET_UPDATE_USER_DETAIL_NEW_KVITTO = 'GET_UPDATE_USER_DETAIL_NEW_KVITTO';
export const GET_UPDATE_USER_DETAIL_MY_KVITTO = 'GET_UPDATE_USER_DETAIL_MY_KVITTO';
export const GET_UPDATE_USER_DETAIL_MY_FAKTUROR = 'GET_UPDATE_USER_DETAIL_MY_FAKTUROR';
export const GET_UPDATE_USER_DETAIL_MY_DOKUMENT = 'GET_UPDATE_USER_DETAIL_MY_DOKUMENT';
export const GET_UPDATE_USER_DETAIL_NEW_INKOP = 'GET_UPDATE_USER_DETAIL_NEW_INKOP';
export const GET_UPDATE_USER_DETAIL_MY_INKOP = 'GET_UPDATE_USER_DETAIL_MY_INKOP';
export const GET_UPDATE_USER_NOTIS = 'GET_UPDATE_USER_NOTIS';
export const ADD_NEW_POST = 'ADD_NEW_POST';
export const GET_MINA_POST = 'GET_MINA_POST';
export const GET_UPDATE_ADMIN_DETAIL_MY_INKOP = 'GET_UPDATE_ADMIN_DETAIL_MY_INKOP';
export const GET_USERS_AKTIVA = 'GET_USERS_AKTIVA';
export const GET_MINA_EVENT = 'GET_MINA_EVENT';
export const ADD_NEW_EVENT = 'ADD_NEW_EVENT';
export const GET_STATISTIC = 'GET_STATISTIC';
export const GET_USER_WORKING_YEARS = 'GET_USER_WORKING_YEARS';
//